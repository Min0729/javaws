...
//		 - 화폐단위 50000   으로 시작해서  /5   /2  의 방식으로 구해 질 수 있다
		...
		int money50000=rem/unit;
		rem=rem%50000;
		unit=unit/5;
		
		int money10000=rem/unit;
		rem=rem%10000;
		unit=unit/2;
		
		int money5000 = rem/unit;
		rem=rem%5000;
		unit=unit/5;
		
		int money1000=rem/unit;
		rem=rem%1000;
		unit=unit/2;
		
		int money500=rem/unit;
		rem=rem%500;
		unit=unit/5;
		
		int money100=rem/unit;
		rem=rem%100;
		unit=unit/2;
		
		int money50=rem/unit;
		rem=rem%50;
		unit=unit/5;
		
		int money10=rem/unit;
		rem=rem%10;
