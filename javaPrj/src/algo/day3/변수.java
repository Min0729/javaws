...
public class 변수 {
	public static void main(String[] args) {
		 ...
		 * 예시) double avg=98.77;
		 * 
		 * boolean: 논리형  true(0이 아닌 값), false(0인값)
		...
		long iLong = 2200000000L;
						// long형 리터럴값을 표현해야 함		숫자L 로 long형 리터럴 표현함
		
		double d=23.3;	// 23.3 실수형리터럴이 double형으로 상수영역에 저장 ok
						// d라는 변수에 저장됨 ok
		
		// float f= 23.3;	// 23.3 상수영역에 저장되는 것이 ok
						// double형이 float변수에 저장될 때 문제 발생 됨
						// 
		...
		// "문자열을 어떻게 표현할까요?"
		// 문자열은 문자여러개가 모인것이다. 문자집합이라고 표현한다.
		...
		char result=str3.charAt(7);
		System.out.println(result);
		
		// 논릭밧을 저장할 수 있는 자료형 boolean	true, false
		boolean flag=false;
